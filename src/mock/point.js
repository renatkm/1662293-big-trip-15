...
import {getRandomInteger, getRandomItem, getOfferListByEventType} from '../utils.js';
import {PointTypeList, DestinationList} from '../const.js';
...
const getRandomPointType= () =>getRandomItem(PointTypeList);

const getRandomDestination= () =>getRandomItem(DestinationList);
...
const getAnyOffers = (pointType) =>{
  const availableOffers =getOfferListByEventType(pointType);
